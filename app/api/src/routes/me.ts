...
const CreatorProfileSchema = z.object({
  ...
  orientation: z.string().trim().toLowerCase().max(30).optional().default(""),
  ...
  availableFor: z.preprocess(normalizeAvailableFor, z.enum(["incall", "outcall", "both"])).optional().default(""),
