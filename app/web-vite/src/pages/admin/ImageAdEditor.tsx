...
export function ImageAdEditor({
  ...
  const placement: Record<ImageSlot, string> = {
    ...
    "home-7":  "Girls Page · Top (landscape)",
    "home-8":  "Girls Page · Bottom (landscape)",
    "home-9":  "Homepage · Top Girls Card Area, position 1 (tablet/mobile <1392px)",
    "home-10": "Homepage · Top Girls Card Area, position 2 (tablet/mobile <1392px)",
    "home-11": "Homepage · Top Girls Card Area, position 3 (tablet/mobile <1392px)",
    "home-12": "Homepage · Top Girls Card Area, position 4 (tablet/mobile <1392px)",
    "home-13": "Girls Page · Side, Top Left (desktop ≥1392px)",
    "home-14": "Girls Page · Side, Bottom Left (desktop ≥1392px)",
    "home-15": "Girls Page · Side, Top Right (desktop ≥1392px)",
    "home-16": "Girls Page · Side, Bottom Right (desktop ≥1392px)",
    "home-17": "Girls Page · Top Girls Card Area, position 1 (tablet/mobile <1392px)",
    "home-18": "Girls Page · Top Girls Card Area, position 2 (tablet/mobile <1392px)",
    "home-19": "Girls Page · Top Girls Card Area, position 3 (tablet/mobile <1392px)",
    "home-20": "Girls Page · Top Girls Card Area, position 4 (tablet/mobile <1392px)",
  };
